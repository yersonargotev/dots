...
| `codex-delegation` | `codex-delegation` | Codex-only delegation skill and generic delegation overlay in `~/.codex/AGENTS.md`, without the broader `agents` baseline. | `npx` via the selected Provisioner Dependency |
